...
window.BIGDATA_LMS={API,STORE,ROOT,$,esc,auth,save,login,authAction,bigdata,core,assess,interop,requestAccess,reviewAccess,logout,fmtTime,fmtWhen,fmtDelay,safeNext,msg,requireBigData,wireLogout,startHeartbeat};
})();