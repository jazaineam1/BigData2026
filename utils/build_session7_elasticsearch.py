# -*- coding: utf-8 -*-
"""Genera S07 zero-to-hero: Elasticsearch, índice invertido y BM25.
PDA 2026-2: práctica de Elasticsearch y búsqueda textual con BM25.
"""
...
NOTEBOOK_JSON = r'''{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "outputs": [],
   "source": "texto_demo = \"Servicios de MANTENIMIENTO de las Aeronaves KFIR\"\ndisplay(mostrar_tokens(texto_demo))"
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": "### Práctica 1 — cambia una frase\n\nModifica solo el texto entre comillas. Observa qué términos quedan."
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "metadata": {},
   "outputs": [],
   "source": "mi_frase = \"mantenimiento de equipo aeronáutico\"\ndisplay(mostrar_tokens(mi_frase))"
  },
  {
   "cell_type": "markdown",
   "metadata": {},
...
def main():
    ...
    print(f"[OK] S07 generada: {len(nb.cells)} celdas -> {OUTPUT}")
