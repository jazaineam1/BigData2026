...
checks=[
    ...
    ("S07 lexical correctamente descrita", "tokens → índice invertido → BM25" in deck),
    ("S09 semántica correctamente descrita", "texto → embedding → similitud → Top-k" in deck),
    ...
    ("LMS recursos", "data-resource" in session and "Presentación" in session and "Cuaderno" in session),
